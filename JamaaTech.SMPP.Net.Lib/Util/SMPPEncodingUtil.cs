...
namespace JamaaTech.Smpp.Net.Lib.Util
{
    ...
    {
        private static Encoding unicode = System.Text.Encoding.Unicode;

        public static System.Text.Encoding UCS2Encoding
        {
            get
            {
                return unicode;
        ...
        public static byte[] GetBytesFromString(string cStr,DataCoding dataCoding)
        {
            ...
            //string hex = UnicodeStr2HexStr(cStr);
            //bytes = HexStr2HexBytes(hex);
            ...
            switch (dataCoding)
            {
                ...
                case DataCoding.Latin1:
                    ...
                    break;
                case DataCoding.UCS2:
                    bytes = HexStr2HexBytes(UnicodeStr2HexStr(cStr));
                    //bytes = UCS2Encoding.GetBytes(cStr);
                    break;
                case DataCoding.SMSCDefault:
                    bytes = SMSCDefaultEncoding.GetBytes(cStr);
